  ...
  const faqs = [
    {
      ...
      answer: 'Я принимаю детей с рождения до 18 лет включительно. Для новорожденных доступен патронаж на дому.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Работаю каждый день с 8:00 до 20:00. В экстренных случаях возможны консультации по телефону.'
    },
    {
